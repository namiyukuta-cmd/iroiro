...
window.DESERT_WORLD_DATA = {
  ...
  gameEconomy: {
    ...
    firstCustomer: {
      ...
      safiraShare: 3.5,
      stay: "一晩",
      included: ["冷えた水", "パン", "アシーダ"],
      meal: {
        name: "アシーダ",
        description: "小麦粉でとろみをつけた、具のない濃い粥状の汁物。パンと一緒に出す簡素な食事。",
        sourceType: "史実料理を参考にした世界設定",
        note: "中世エジプト料理に見られるʿaṣīdaを参考にする。作品内では庶民的で簡素な食事として扱う。"
      },
      pricingPosition: "安め",
      pricingReason: "一晩泊まり、水と簡単な食事まで付くため内容に対しては安め。ただし、狭い個室・経験の浅いサフィラ・貸主の紹介客限定・大々的に客を集めないという条件込みの価格。",
      landlordPolicy: "貸主は大々的な売春宿として営業して役人や近隣に目をつけられることを避けたい。紹介できる客を少人数だけ回し、サフィラは原則として一晩に一人を泊める。",
      note: "ラシードは6ディルハムを払う。貸主2.5、サフィラ3.5。代金には一晩の滞在、冷えた水、パン、アシーダの簡単な食事を含む。"
    },
