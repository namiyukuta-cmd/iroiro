...
window.DESERT_NPC_DATA = {
  ...
  characters: [
    ...
    },
    {
      ...
      notes: "貸主の知人。隊商の荷と帳簿を管理している38歳の男。妻子は故郷にいる。貸主からサフィラを売春の相手として紹介され、その意味を理解したうえで部屋を訪れる。荒っぽい男ではなく、相手をよく観察してから動く。貸主との信用を重んじ、紹介されたサフィラに対しても最初から無茶をする気はない。サフィラが不慣れであることには気づくが、客として来た目的そのものを知らないわけではない。"
    },
    {
      id: "family_sister_01",
      category: "家族",
