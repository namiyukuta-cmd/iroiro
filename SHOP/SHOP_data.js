(() => {
  ...
  window.SHOP_DATA = Object.freeze({
    ...
    scenes: Object.freeze({
      outerPoor: Object.freeze({
        ...
        objects: Object.freeze([
          // ② 第2の1/3：背景用家層
          Object.freeze({src:'./asset/house_poor.png', left:-6, bottom:24, height:104, layer:'house'}),
          Object.freeze({src:'./asset/house_poor.png', left:74, bottom:24, height:104, layer:'house', flip:true}),
          Object.freeze({src:'./asset/house_poor.png', left:23, bottom:20, height:68, layer:'house', flip:true}),
          Object.freeze({src:'./asset/house_poor.png', left:57, bottom:20, height:68, layer:'house'}),

          // ③ 第2の1/3：背景用NPC層
          Object.freeze({src:'https://raw.githubusercontent.com/namiyukuta-cmd/iroiro/main/SHOP/asset/Npc/npc_oldman_01.png', left:19, bottom:10, height:58, layer:'backgroundNpc'}),
          Object.freeze({src:'https://raw.githubusercontent.com/namiyukuta-cmd/iroiro/main/SHOP/asset/Npc/npc_porter_01.png', left:82, bottom:10, height:58, layer:'backgroundNpc'}),

          // ④ 第2の1/3：選択可能ショップ・NPC層
          Object.freeze({src:'./asset/stall.png', left:47, bottom:0, height:82, layer:'interactive', selectable:true, selectableType:'shop'}),
          Object.freeze({src:'https://raw.githubusercontent.com/namiyukuta-cmd/iroiro/main/SHOP/asset/Npc/npc_beggar_01.png', left:31, bottom:0, height:72, layer:'interactive', selectable:true, selectableType:'npc'})
        ])
      }),
    ...
    links: Object.freeze({
      newGame: './SHOP_top.html?new=1&build=20260923-1043',
      continueGame: './SHOP_top.html?continue=1&build=20260923-1043',
