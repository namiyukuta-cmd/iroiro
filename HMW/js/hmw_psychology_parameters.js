(() => {
  ...
  const psychology = {
    ...
    romanceOnsetModel: {
      principle: [
        ...
        "主人公側が初対面でも、恋愛相手側には priorAwareness / priorInterest / priorCrush がある可能性を持てる。ただし実ログ・人物設定に根拠がない事前関係をAIが勝手に確定してはいけない。",
    ...
    conflictModel: {
      note: "これは人間心理の医学的モデルではなく、HMW生成用の行動決定ヒューリスティック。単純な一感情最大値ではなく、欲求側と抑制側の拮抗を見る。",
    ...
    intimacyExpression: {
      scope: "主人公・恋愛相手が成人である恋愛作品における、非露骨な親密さの希望・誘い・軽い身体接触を扱う。",
      ...
      protagonistAgency: "恋愛相手が自分から誘う・触れる・抱きしめる・キスする等の行動は生成してよいが、主人公側の受諾・台詞・心理・身体反応をAIが勝手に補完しない。",
    ...
    combinationEffects: [
      ...
      "kissImpulse / embraceImpulse が高くphysicalInitiativeも高い → 段階と状況が許せば恋愛相手側から軽い身体接触を起こす。",
    ...
    updateRules: [
      ...
      "主人公が何もしなくても、seekHeroine / pursuitDrive / longing / needForClarity 等が高ければ恋愛相手自身を起点に行動を開始する。",
      "selfWorth / romanticConfidence / perceivedAffection 等の認知値は、事実そのものではなく恋愛相手本人の現在認知として扱う。実ログと矛盾する誤解を持つこともある。",
  ...
  window.HMWPsychologyParameters = Object.freeze(psychology);
})();