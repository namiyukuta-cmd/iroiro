(() => {
  ...
  add("R401_REQ_TOUCH_ALLOW",780,{intentAny:["request_action"],questionAny:{kindAny:["request_action"],actionAny:["touch"]},policyEq:{"requestResponses.touch":true},boundaryNone:["do_not_touch"]},["ACCEPT_ACTION_REQUEST"],"request_touch_allowed");
  add("R402_REQ_TOUCH_DENY",800,{intentAny:["request_action"],questionAny:{kindAny:["request_action"],actionAny:["touch"]},policyEq:{"requestResponses.touch":false}},["DECLINE_ACTION_REQUEST"],"request_touch_denied");
  add("R403_REQ_HUG_ALLOW",780,{intentAny:["request_action"],questionAny:{kindAny:["request_action"],actionAny:["hug"]},policyEq:{"requestResponses.hug":true},boundaryNone:["do_not_hug","do_not_touch"]},["ACCEPT_ACTION_REQUEST"],"request_hug_allowed");
  add("R404_REQ_HUG_DENY",800,{intentAny:["request_action"],questionAny:{kindAny:["request_action"],actionAny:["hug"]},policyEq:{"requestResponses.hug":false}},["DECLINE_ACTION_REQUEST"],"request_hug_denied");
  add("R405_REQ_KISS_ALLOW",780,{intentAny:["request_action"],questionAny:{kindAny:["request_action"],actionAny:["kiss"]},policyEq:{"requestResponses.kiss":true},boundaryNone:["do_not_kiss","do_not_touch"]},["ACCEPT_ACTION_REQUEST"],"request_kiss_allowed");
  add("R406_REQ_KISS_DENY",800,{intentAny:["request_action"],questionAny:{kindAny:["request_action"],actionAny:["kiss"]},policyEq:{"requestResponses.kiss":false}},["DECLINE_ACTION_REQUEST"],"request_kiss_denied");
  add("R407_REQ_CALL_ALLOW",750,{intentAny:["request_action"],questionAny:{kindAny:["request_action"],actionAny:["call"]},policyEq:{"requestResponses.call":true},boundaryNone:["do_not_call","do_not_contact"]},["ACCEPT_ACTION_REQUEST"],"request_call_allowed");
  add("R408_REQ_CALL_DENY",780,{intentAny:["request_action"],questionAny:{kindAny:["request_action"],actionAny:["call"]},policyEq:{"requestResponses.call":false}},["DECLINE_ACTION_REQUEST"],"request_call_denied");
  add("R409_REQ_MESSAGE_ALLOW",750,{intentAny:["request_action"],questionAny:{kindAny:["request_action"],actionAny:["message"]},policyEq:{"requestResponses.message":true},boundaryNone:["do_not_message","do_not_contact"]},["ACCEPT_ACTION_REQUEST"],"request_message_allowed");
  add("R410_REQ_MESSAGE_DENY",780,{intentAny:["request_action"],questionAny:{kindAny:["request_action"],actionAny:["message"]},policyEq:{"requestResponses.message":false}},["DECLINE_ACTION_REQUEST"],"request_message_denied");
  add("R411_INVITE_TALK_ALLOW",750,{intentAny:["invite_action"],questionAny:{kindAny:["invite_action"],actionAny:["talk"]},policyEq:{"invitationResponses.talk":true},boundaryNone:["stop_conversation"]},["ACCEPT_INVITATION"],"invite_talk_allowed");
  add("R412_INVITE_TALK_DENY",750,{intentAny:["invite_action"],questionAny:{kindAny:["invite_action"],actionAny:["talk"]},policyEq:{"invitationResponses.talk":false}},["DECLINE_INVITATION"],"invite_talk_denied");
  add("R413_INVITE_GO_ALLOW",740,{intentAny:["invite_action"],questionAny:{kindAny:["invite_action"],actionAny:["go"]},policyEq:{"invitationResponses.go":true}},["ACCEPT_INVITATION"],"invite_go_allowed");
  add("R414_INVITE_GO_DENY",740,{intentAny:["invite_action"],questionAny:{kindAny:["invite_action"],actionAny:["go"]},policyEq:{"invitationResponses.go":false}},["DECLINE_INVITATION"],"invite_go_denied");
  add("R415_SUGGEST_WAIT_ALLOW",730,{intentAny:["suggest_action"],questionAny:{kindAny:["suggest_action"],actionAny:["wait"]},policyEq:{"suggestionResponses.wait":true}},["ACCEPT_SUGGESTION"],"suggest_wait_allowed");
  add("R416_SUGGEST_WAIT_DENY",730,{intentAny:["suggest_action"],questionAny:{kindAny:["suggest_action"],actionAny:["wait"]},policyEq:{"suggestionResponses.wait":false}},["DECLINE_SUGGESTION"],"suggest_wait_denied");
