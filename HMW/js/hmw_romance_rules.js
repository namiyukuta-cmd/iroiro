(() => {
  ...
  const rules = {
    ...
    aiWorkflow: [
      ...
      "2. 対象キャラクターJSを読む。",
      "3. この共通恋愛ルールを読む。",
      "4. js/hmw_psychology_parameters.js を読み、旧stateなら不足項目をnormalizeStateで補完して判断に使う。",
      "5. 作品固有の恋愛ルールを読む。",
      ...
      "21. 心理値と各派生判定結果はHMW.state.relationships内の各恋愛相手へ保持する。端末内保存とprivate-game-dataへの保存はHMW既存セーブ方式に従う。",
