(() => {
  ...
  const character = {
    ...
    appearance: {
      age: 34,
      heightCm: 185,
      build: "肩幅が広く、無駄の少ないがっしりした体格。鍛えていることは分かるが、誇示するような体つきではない。",
      hair: "濃いブラウン。短く整え、勤務中はほとんど崩れない。",
      eyes: "青灰色。視線は落ち着いていて、相手を見る時に逸らさない。",
      face: "直線的な眉と少し角張った顎。鼻筋が通り、普段は表情が控えめ。笑うと右の頬に浅い線が出る。",
      skin: "明るめで、屋外勤務による薄い日焼けがある。",
      grooming: "常に清潔で髭は剃っている。制服や私服にも乱れが少ない。",
      clothing: "勤務中は警察官の制服。非番では無地のシャツや薄手のニット、暗色のパンツを選ぶことが多い。",
      distinguishing: ["左眉の上に近くで見ないと分からない細い古傷", "腕時計を必ず左手につけている"],
      impression: "職務中は近寄りがたいほど整って見えるが、表情が緩むと年齢相応の穏やかさが出る。"
    },
    core: {
